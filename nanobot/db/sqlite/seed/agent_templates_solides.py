...
_SKILL_AUTHOR: dict[str, Any] = {
    ...
    "guardrails": (
        ...
        "\"não informado\" não substitui perguntar. Pergunte numa frase dirigida "
        "à pessoa, com exemplo do formato esperado, e espere a resposta antes de "
        "chamar `save_skill` — nunca um aviso de sistema tipo \"Aguardando o "
